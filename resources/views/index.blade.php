    ...
    <nav class="navbar navbar-expand-lg fixed-top" style="background-color:#435ebe">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="navbar-nav d-none d-lg-flex">
                <a class="btn btn-light me-2 text-light rounded-pill fw-bold fs-6" href="{{ route('login') }}"
                    role="button" style="background-color: #435ebe;">Login</a>
                <a class="btn btn-light text-light  rounded-pill fw-bold fs-6" href="{{ route('register') }}"
                    role="button" style="background-color: #435ebe;">Register</a>
            </div>
            <div class="navbar-nav d-flex d-lg-none justify-content-end">
                <div class="dropdown">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 col-lg-7">
                ...
                <p class="text-dark text-center d-md-none" style="font-size: 15px">Selamat datang di <span
                        class="fw-bold" style="color:#435ebe">Goola Quiz</span>, platform interaktif yang dirancang
                    khusus untuk
                    menguji dan memperluas pengetahuan Anda tentang diabetes. Apakah Anda seorang pasien, caregiver,
                    atau profesional kesehatan, situs ini menawarkan berbagai kuis yang menarik dan mendidik untuk semua
                    tingkat pengetahuan.</p>
                ...
                <div class="row g-0 mt-4">
                    ...
                    <div class="col-md-7 col-lg-8">
                        <div class="card-body p-4">
                            ...
                            <a href="{{ route('login') }}" class="btn btn-primary fs-5 text-light btn-sm w-100"
