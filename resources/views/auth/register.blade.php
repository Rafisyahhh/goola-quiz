...
<head>
    ...
    <title>Register - Diabet Quiz</title>
            ...
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo" style="margin-bottom:4rem">
                        <a href="index.html"><img src="{{ asset('image/logo4.png') }}" width="200px"
                                alt="Logo"></a>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password" class="form-control form-control-xl" name="password_confirmation" required autocomplete="new-password" placeholder="Re-Password">
                            <div class="form-control-icon">
                                <i class="bi bi-shield-lock"></i>
                            </div>
                        </div>
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class='text-gray-600'>Sudah Mempunyai Akun?
                            @if (Route::has('login'))
                            <a href="{{ route('login') }}"
                                class="font-bold">Login disini</a>
                            @endif</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-7 d-none d-lg-block">
                <div id="auth-right" style="background: #435ebe">
                    <img src="{{ asset('image/diabet2.png') }}" alt="" width="100%">
                </div>
            </div>
        </div>
